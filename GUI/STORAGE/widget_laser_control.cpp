...
void WidgetLaserControl::setPilotEnable(bool OnOff)
{
    ui->butLaserPilot->setEnabled(OnOff);
    if( OnOff) ui->butLaserPilot->setText("Пилот");
    if(!OnOff) ui->butLaserPilot->setText("");
}
