...
QList<QString> OnvifMediaService::onvif_schemas
{
    "xmlns:trt=\"http://www.onvif.org/ver10/media/wsdl\"",
    "xmlns:tt=\"http://www.onvif.org/ver10/schema\""
};

QList<MediaProfile> OnvifMediaService::GetProfiles(QString addressMedia, QString username, QString password)
{
    SoapRequest *soapRequest = new SoapRequest();
    soapRequest->address = addressMedia;
    ...
    bool got_response = soapRequest->sendRequest(response); delete soapRequest;
     if(!got_response) return result; 
